<%-- 
    Document   : ARMResult
    Created on : Jan 24, 2015, 6:33:40 PM
    Author     : admin
--%>
...
<div id="header">
    ...
    <div id="content">
    <br/>
    <h2 style=" color: #254360">Association Result</h2> <br/>
		
    <%
        BRS_Servlet.DBConnection db=new BRS_Servlet.DBConnection();
        Statement st=db.stt;
        ResultSet rs1=st.executeQuery("select * from arm");
    ...
    <th style=" color: #254360"><center>Value</center></th>
           ...
           <br>
                     <input type="submit" value="Get Recommendation"></center>
<br/> <br/>
	</div>
    </div>
<div id="footer">
