<%-- 
    Document   : Search
    Created on : Jan 24, 2015, 10:32:06 AM
    Author     : admin
--%>
...
function check()
{
    var n1=document.getElementById('sr1').value;
    if(n1=="")
        alert("Enter Keyword");
    else
    {
        var ff=document.getElementById('fm1');
        ff.action="./UserSeachBook"
        ff.submit();
    }
}
</script>
...
<div id="header">
    ...
    <div id="content">
    <br/>
    <h2 style=" color: #254360">Search Book</h2> <br/>
    <table> 
        <tr>
            <td>Enter Keyword</td>
            <td>
                <input type="text" id="sr1" name="sr1">
            </td>
